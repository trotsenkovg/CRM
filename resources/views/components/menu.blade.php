            ...
            <div>
                ...
                <ul class="mt-3">
                    ...
                    <li class="px-3 py-2 rounded-sm mb-0.5 last:mb-0" :class="{ 'bg-slate-900': page.startsWith('dashboard-') }" x-data="{ open: false }" x-init="$nextTick(() => open = page.startsWith('dashboard-'))">
                        <a class="block text-slate-200 hover:text-white truncate transition duration-150" :class="page.startsWith('dashboard-') && 'hover:text-slate-200'" href="#0" @click.prevent="sidebarExpanded ? open = !open : sidebarExpanded = true">
                    ...
                    <li class="px-3 py-2 rounded-sm mb-0.5 last:mb-0" :class="{ 'bg-slate-900': page.startsWith('ecommerce-') }" x-data="{ open: false }" x-init="$nextTick(() => open = page.startsWith('ecommerce-'))">
                        <a class="block text-slate-200 hover:text-white truncate transition duration-150" :class="page.startsWith('ecommerce-') && 'hover:text-slate-200'" href="#0" @click.prevent="sidebarExpanded ? open = !open : sidebarExpanded = true">
                            <div class="flex items-center justify-between">
                                <div class="flex items-center">
                                    <svg class="shrink-0 h-6 w-6" viewBox="0 0 24 24">
                        ...
                        <div class="lg:hidden lg:sidebar-expanded:block 2xl:block">
                            <ul class="pl-9 mt-1" :class="!open && 'hidden'" x-cloak>
                                <li class="mb-1 last:mb-0">
                                    <a class="block text-slate-400 hover:text-slate-200 transition duration-150 truncate" :class="page === 'ecommerce-customers' && '!text-indigo-500'" href="customers.html">
                                ...
                                <li class="mb-1 last:mb-0">
                                    <a class="block text-slate-400 hover:text-slate-200 transition duration-150 truncate" :class="page === 'ecommerce-invoices' && '!text-indigo-500'" href="invoices.html">
                                ...
                                <li class="mb-1 last:mb-0">
                                    <a class="block text-slate-400 hover:text-slate-200 transition duration-150 truncate" :class="page === 'ecommerce-shop-2' && '!text-indigo-500'" href="shop-2.html">
                                ...
                                <li class="mb-1 last:mb-0">
                                    <a class="block text-slate-400 hover:text-slate-200 transition duration-150 truncate" :class="page === 'ecommerce-cart' && '!text-indigo-500'" href="cart.html">
                                ...
                                <li class="mb-1 last:mb-0">
                                    <a class="block text-slate-400 hover:text-slate-200 transition duration-150 truncate" :class="page === 'ecommerce-cart-3' && '!text-indigo-500'" href="cart-3.html">
                    ...
                    <!-- Community -->
                    <li class="px-3 py-2 rounded-sm mb-0.5 last:mb-0" :class="{ 'bg-slate-900': page.startsWith('community-') }" x-data="{ open: false }" x-init="$nextTick(() => open = page.startsWith('community-'))">
                        <a class="block text-slate-200 hover:text-white truncate transition duration-150" :class="page.startsWith('community-') && 'hover:text-slate-200'" href="#0" @click.prevent="sidebarExpanded ? open = !open : sidebarExpanded = true">
                            <div class="flex items-center justify-between">
                                <div class="flex items-center">
                                    <svg class="shrink-0 h-6 w-6" viewBox="0 0 24 24">
                        ...
                        <div class="lg:hidden lg:sidebar-expanded:block 2xl:block">
                            <ul class="pl-9 mt-1" :class="!open && 'hidden'" x-cloak>
                                <li class="mb-1 last:mb-0">
                                    <a class="block text-slate-400 hover:text-slate-200 transition duration-150 truncate" :class="page === 'community-tabs' && '!text-indigo-500'" href="users-tabs.html">
                                ...
                                <li class="mb-1 last:mb-0">
                                    <a class="block text-slate-400 hover:text-slate-200 transition duration-150 truncate" :class="page === 'community-profile' && '!text-indigo-500'" href="profile.html">
                                ...
                                <li class="mb-1 last:mb-0">
                                    <a class="block text-slate-400 hover:text-slate-200 transition duration-150 truncate" :class="page === 'community-forum' && '!text-indigo-500'" href="forum.html">
                                ...
                                <li class="mb-1 last:mb-0">
                                    <a class="block text-slate-400 hover:text-slate-200 transition duration-150 truncate" :class="page === 'community-meetups' && '!text-indigo-500'" href="meetups.html">
                    ...
                    <li class="px-3 py-2 rounded-sm mb-0.5 last:mb-0" :class="{ 'bg-slate-900': page.startsWith('finance-') }" x-data="{ open: false }" x-init="$nextTick(() => open = page.startsWith('finance-'))">
                        <a class="block text-slate-200 hover:text-white truncate transition duration-150" :class="page.startsWith('finance-') && 'hover:text-slate-200'" href="#0" @click.prevent="sidebarExpanded ? open = !open : sidebarExpanded = true">
                            <div class="flex items-center justify-between">
                                <div class="flex items-center">
                                    <svg class="shrink-0 h-6 w-6" viewBox="0 0 24 24">
                                        ...
                                        <path class="fill-current text-slate-600" :class="page.startsWith('finance-') && 'text-indigo-600'" d="M6.939 15.007A5.861 5.861 0 0 1 6 11.829c0-2.937 2.167-5.376 5-5.85V0C4.85.507 0 5.614 0 11.83c0 2.695.922 5.174 2.456 7.17l4.483-3.993Z" />
                                    </svg>
                    ...
                    <li class="px-3 py-2 rounded-sm mb-0.5 last:mb-0" :class="{ 'bg-slate-900': page.startsWith('job-') }" x-data="{ open: false }" x-init="$nextTick(() => open = page.startsWith('job-'))">
                        <a class="block text-slate-200 hover:text-white truncate transition duration-150" :class="page.startsWith('job-') && 'hover:text-slate-200'" href="#0" @click.prevent="sidebarExpanded ? open = !open : sidebarExpanded = true">
                            <div class="flex items-center justify-between">
                                <div class="flex items-center">
                                    <svg class="shrink-0 h-6 w-6" viewBox="0 0 24 24">
                                        ...
                                        <path class="fill-current text-slate-400" :class="page.startsWith('job-') && '!text-indigo-300'" d="M21.554 2.471A8.958 8.958 0 0 0 18.167.276a3.105 3.105 0 0 0-3.295.467L9.715 5.888c-1.41 1.408-.665 4.275 1.733 6.668a8.958 8.958 0 0 0 3.387 2.196c.459.157.94.24 1.425.246a2.559 2.559 0 0 0 1.87-.715l5.156-5.146c1.415-1.406.666-4.273-1.732-6.666Zm.318 5.257c-.148.147-.594.2-1.256-.018A7.037 7.037 0 0 1 18.016 6c-1.73-1.728-2.104-3.475-1.73-3.845a.671.671 0 0 1 .465-.129c.27.008.536.057.79.146a7.07 7.07 0 0 1 2.6 1.711c1.73 1.73 2.105 3.472 1.73 3.846Z" />
                                    </svg>
                    ...
                    <li class="px-3 py-2 rounded-sm mb-0.5 last:mb-0" :class="{ 'bg-slate-900': page.startsWith('tasks-') }" x-data="{ open: false }" x-init="$nextTick(() => open = page.startsWith('tasks-'))">
                        ...
                        <div class="lg:hidden lg:sidebar-expanded:block 2xl:block">
                            <ul class="pl-9 mt-1" :class="!open && 'hidden'" x-cloak>
                                <li class="mb-1 last:mb-0">
                                    <a class="block text-slate-400 hover:text-slate-200 transition duration-150 truncate" :class="page === 'tasks-kanban' && '!text-indigo-500'" href="tasks-kanban.html">
                    ...
                    <!-- Messages -->
                    <li class="px-3 py-2 rounded-sm mb-0.5 last:mb-0" :class="page === 'messages' && 'bg-slate-900'">
                    ...
                    <!-- Campaigns -->
                    <li class="px-3 py-2 rounded-sm mb-0.5 last:mb-0" :class="page === 'campaigns' && 'bg-slate-900'">
                        <a class="block text-slate-200 hover:text-white truncate transition duration-150" :class="page === 'campaigns' && 'hover:text-slate-200'" href="campaigns.html">
                            <div class="flex items-center">
                                <svg class="shrink-0 h-6 w-6" viewBox="0 0 24 24">
                                    ...
                                    <path class="fill-current text-slate-400" :class="page === 'campaigns' && 'text-indigo-300'" d="M17 23a1 1 0 01-1-1 4 4 0 00-4-4 1 1 0 010-2 4 4 0 004-4 1 1 0 012 0 4 4 0 004 4 1 1 0 010 2 4 4 0 00-4 4 1 1 0 01-1 1zM7 13a1 1 0 01-1-1 4 4 0 00-4-4 1 1 0 110-2 4 4 0 004-4 1 1 0 112 0 4 4 0 004 4 1 1 0 010 2 4 4 0 00-4 4 1 1 0 01-1 1z" />
                                </svg>
                    ...
                    <li class="px-3 py-2 rounded-sm mb-0.5 last:mb-0" :class="{ 'bg-slate-900': page.startsWith('settings-') }" x-data="{ open: false }" x-init="$nextTick(() => open = page.startsWith('settings-'))">
                        <a class="block text-slate-200 hover:text-white truncate transition duration-150" :class="page.startsWith('settings-') && 'hover:text-slate-200'" href="#0" @click.prevent="sidebarExpanded ? open = !open : sidebarExpanded = true">
                            <div class="flex items-center justify-between">
                                <div class="flex items-center">
                                    <svg class="shrink-0 h-6 w-6" viewBox="0 0 24 24">
                    ...
                    <li class="px-3 py-2 rounded-sm mb-0.5 last:mb-0" :class="{ 'bg-slate-900': page.startsWith('utility-') }" x-data="{ open: false }" x-init="$nextTick(() => open = page.startsWith('utility-'))">
                        <a class="block text-slate-200 hover:text-white truncate transition duration-150" :class="page.startsWith('utility-') && 'hover:text-slate-200'" href="#0" @click.prevent="sidebarExpanded ? open = !open : sidebarExpanded = true">
                            <div class="flex items-center justify-between">
                                <div class="flex items-center">
                                    <svg class="shrink-0 h-6 w-6" viewBox="0 0 24 24">
            ...
            <div>
                ...
                <ul class="mt-3">
                    ...
                    <li class="px-3 py-2 rounded-sm mb-0.5 last:mb-0" x-data="{ open: false }">
                        <a class="sidebar-expander-link block text-slate-200 hover:text-white transition duration-150" :class="open && 'hover:text-slate-200'" href="#0" @click.prevent="sidebarExpanded ? open = !open : sidebarExpanded = true">
                            <div class="flex items-center justify-between">
                                <div class="flex items-center">
                                    <svg class="shrink-0 h-6 w-6" viewBox="0 0 24 24">
