<div>
    ...
    <div
        id="sidebar"
        class="flex flex-col absolute z-40 start-0 top-0 lg:static lg:left-auto lg:top-auto lg:translate-x-0 transform h-screen overflow-y-scroll lg:overflow-y-auto no-scrollbar w-64 lg:w-20 lg:sidebar-expanded:!w-64 2xl:!w-64 shrink-0 bg-orange-800 p-4 transition-all duration-200 ease-in-out"
        ...
        <div class="space-y-8">
            ...
            <div>
                ...
                <ul class="mt-3">
                    <!-- Dashboard -->
                    <li x-cloak class="px-3 py-2 rounded-sm mb-0.5 last:mb-0" :class="page === 'dashboard' && 'bg-orange-900'">
                        <a class="block text-orange-200 hover:text-white truncate transition duration-150"
                           :class="page === 'dashboard' && 'hover:text-orange-200'" href="{{ route('dashboard')}}"
                           x-cloak>
                            <div class="flex items-center">
                                <svg class="shrink-0 h-6 w-6" viewBox="0 0 24 24">
                                    <path class="fill-current text-orange-400"
                                          :class="page.startsWith('dashboard') && '!text-orange-500'"
                                          d="M12 0C5.383 0 0 5.383 0 12s5.383 12 12 12 12-5.383 12-12S18.617 0 12 0z"/>
                                    <path class="fill-current text-orange-600"
                                          :class="page.startsWith('dashboard') && 'text-orange-600'"
                                          d="M12 3c-4.963 0-9 4.037-9 9s4.037 9 9 9 9-4.037 9-9-4.037-9-9-9z"/>
                                    <path class="fill-current text-orange-400"
                                          :class="page.startsWith('dashboard') && 'text-orange-200'"
                                          d="M12 15c-1.654 0-3-1.346-3-3 0-.462.113-.894.3-1.285L6 6l4.714 3.301A2.973 2.973 0 0112 9c1.654 0 3 1.346 3 3s-1.346 3-3 3z"/>
                                </svg>
                                <span class="text-sm font-medium ms-3 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">@lang('general.dashboard')</span>
                            </div>
                        </a>
                    </li>
                    <!-- Users -->
                    <li x-cloak class="px-3 py-2 rounded-sm mb-0.5 last:mb-0"
                        :class="{ 'bg-orange-900': page.startsWith('siteUsers') || page.startsWith('addSiteUsers') }"
                        x-data="{ open: false, open1: false }"
                        x-init="$nextTick(() => open = page.startsWith('siteUsers') || page.startsWith('addSiteUsers'))">
                        <a class="block text-orange-200 hover:text-white truncate transition duration-150"
                           :class="page.startsWith('siteUsers') || page.startsWith('addSiteUsers') && 'hover:text-orange-200'"
                        ...
                        <div class="lg:hidden lg:sidebar-expanded:block 2xl:block">
                            <ul class="ps-9 mt-1 list-disc"
                                ...
                                <li class="mb-1 last:mb-0 cursor-pointer"
                                    ...
                                    <a class="block text-orange-400 hover:text-orange-200 transition duration-150 truncate ps-2"
                                       :class="{ '!text-orange-200': page.startsWith('siteUsers') || page.startsWith('addSiteUsers')}"
                                    ...
                                    <ul class="ps-4 mt-1 list-disc"
                                        ...
                                        <li class="mb-1 last:mb-0 cursor-pointer">
                                            <a class="block text-orange-400 hover:text-orange-200 transition duration-150 truncate ps-2"
                                               :class="{ '!text-orange-200': page.startsWith('siteUsers') }"
                                        ...
                                        <li class="mb-1 last:mb-0 cursor-pointer">
                                            <a class="block text-orange-400 hover:text-orange-200 transition duration-150 truncate ps-2"
                                               :class="{ '!text-orange-200': page.startsWith('addSiteUsers') }"
                                ...
                                <li class="mb-1 last:mb-0 cursor-pointer">
                                    <a class="block text-orange-400 hover:text-orange-200 transition duration-150 truncate ps-2"
                                       :class="page === 'settings-account' && '!text-orange-500'" href="settings.html">
                                        <span
                        ...
                        <div class="lg:hidden lg:sidebar-expanded:block 2xl:block">
                            <ul class="ps-9 mt-1"
                                ...
                                <li class="mb-1 last:mb-0">
                                    <a class="block text-orange-400 hover:text-orange-200 transition duration-150 truncate"
                                       :class="page === 'settings-account' && '!text-orange-500'" href="settings.html">
                                        <span
                ...
                <button @click="sidebarExpanded = !sidebarExpanded">
                    ...
                    <svg class="w-6 h-6 fill-current" viewBox="0 0 24 24"
                        ...
                        @else
                            :class="sidebarExpanded && 'rotate-180'">
                        @endif
                        <path class="text-orange-400"
                              d="M19.586 11l-5-5L16 4.586 23.414 12 16 19.414 14.586 18l5-5H7v-2z"/>
                        <path class="text-orange-600" d="M3 23H1V1h2z"/>
                    </svg>
                </button>
            </div>
        </div>
