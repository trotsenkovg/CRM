...
<div>
    <div class="sm:mx-auto sm:w-full sm:max-w-md">
        <a href="{{ route('login') }}">
            <x-login-logo class="w-auto h-16 mx-auto text-slate-600"></x-login-logo>
        </a>
        <hr>
    </div>

    <div class="sm:mx-auto sm:w-full sm:max-w-md">
        <div class="px-4 py-8 bg-white shadow sm:rounded-b-lg sm:px-10">
                ...
                <div class="flex items-center justify-between mt-6">
                    <div class="flex items-center">
                        <input wire:model.lazy="remember" id="remember" type="checkbox"
                               class="form-checkbox w-4 h-4 text-slate-600 transition duration-150 ease-in-out"/>
